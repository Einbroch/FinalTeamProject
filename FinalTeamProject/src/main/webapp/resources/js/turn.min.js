...
(function(h) {
	var x,
		...
		g = {
			init : function(a) {
				...
				this.css({
					...
					width : a.width,
					height : a.height
				});this.turn("display", a.display);x && !q && a.acceleration && this.transform(s(0, 0, !0));
				for (b = 0; b < d.length; b++) this.turn("addPage", d[b], b + 1);
				this.turn("page", a.page);
				J = h.extend({}, J, a.corners);h(this).bind(I.start, function(a) {
			...
			addPage : function(a, b) {
				...
				1 <= b && b <= e && (d.done && this.turn("stop"), b in d.pageObjs && g._movePages.call(this, b, 1), c && (d.totalPages = e), d.pageObjs[b] = h(a).addClass("turn-page p" + b), g._addPage.call(this, b), d.done && this.turn("update"), g._removeFromDOM.call(this));return this
			},
			_addPage : function(a) {
				var b = this.data(),
					c = b.pageObjs[a];
				if (c)
					if (g._necessPage.call(this, a)) {
						if (!b.pageWrap[a]) {
							...
							}).css(K["double" == b.display ? a % 2 : 0]);this.append(b.pageWrap[a]);b.pageWrap[a].prepend(b.pageObjs[a])
						}
			...
			_removePageFromDOM : function(a) {
				...
				if (b.pages[a]) {
					...
					c.f && c.f.fwrapper && c.f.fwrapper.remove();b.pages[a].remove();
					delete b.pages[a]
				}
				b.pageObjs[a] && b.pageObjs[a].remove();b.pageWrap[a] && (b.pageWrap[a].remove(),
				delete b.pageWrap[a]
				);
			...
			removePage : function(a) {
				var b = this.data();
				b.pageObjs[a] && (this.turn("stop"), g._removePageFromDOM.call(this, a),
				delete b.pageObjs[a]
				, g._movePages.call(this, a, -1), b.totalPages -= 1, g._makeRange.call(this), b.page > b.totalPages && this.turn("page", b.totalPages));return this
			},
			_movePages : function(a, b) {
				var c,
					...
					f = function(a) {
						var c = a + b,
							f = c % 2;
						d.pageObjs[a] && (d.pageObjs[c] = d.pageObjs[a].removeClass("page" + a).addClass("page" + c));d.pagePlace[a] && d.pageWrap[a] && (d.pagePlace[c] = c, d.pageWrap[c] = d.pageWrap[a].css(K[e ?
			...
			_addMv : function(a) {
				var b = this.data();
				g._removeMv.call(this, a);b.pageMv.push(a)
			},
			_view : function(a) {
				var b = this.data(),
					a = a || b.page;
			...
			stop : function() {
				var a,
					...
					c = this.data(),
					d = c.pageMv;
				c.pageMv = [];c.tpage && (c.page = c.tpage,
				delete c.tpage
				);
				for (a in d) p(a, d) && (b = c.pages[d[a]].data().f.opts, i._moveFoldingPage.call(c.pages[d[a]], null), c.pages[d[a]].flip("hideFoldedPage"), c.pagePlace[b.next] = b.next, b.force && (b.next = 0 === b.page % 2 ? b.page - 1 : b.page + 1,
					delete b.force
					));
			...
			_fitPage : function(a, b) {
				var c = this.data(),
					d = this.turn("view", a);
				c.page != a && (this.trigger("turning", [ a, d ]), -1 != h.inArray(1, d) && this.trigger("first"), -1 != h.inArray(c.totalPages, d) && this.trigger("last"));c.pageObjs[a] && (c.tpage = a, this.turn("stop", b), g._removeFromDOM.call(this), g._makeRange.call(this), this.trigger("turned",
					[ a, d ]))
			},
			...
			_addMotionPage : function() {
				var a = h(this).data().f.opts,
					b = a.turn,
					c = b.data();
				a.pageMv = a.page;g._addMv.call(b, a.pageMv);
				c.pagePlace[a.next] = a.page;b.turn("update")
			},
			_start : function(a, b, c) {
				var d = b.turn.data(),
					e = h.Event("start");
				a.stopPropagation();b.turn.trigger(e, [ b, c ]);
			...
			calculateZ : function(a) {
				...
				var h = b[0] || b[1],
					...
					j = function(a) {
						a = f.turn("view", a);a[0] && (g.pageV[a[0]] = !0);a[1] && (g.pageV[a[1]] = !0)
					};
		...
		i = {
			init : function(a) {
				a.gradients && (a.frontGradient = !0, a.backGradient = !0);this.data({
					f : {}
				});this.flip("options", a);i._addPageWrapper.call(this);return this
			},
			setData : function(a) {
				var b = this.data();
			...
			_cornerActivated : function(a) {
				...
				if (a.y < b)
					...
					a.corner = "b";else return !1;
				if (a.x <= b)
					a.corner += "l";
				else if (a.x >= d - b)
					a.corner += "r";else return !1;
			...
			_addPageWrapper : function() {
				...
				if (!a.wrapper) {
					...
					a.parent = b;
					a.fparent = a.opts.turn ? a.opts.turn.data().fparent : h("#turn-fwrappers");a.fparent || (c = h("<div/>", {
						css : {
							"pointer-events" : "none"
						}
					}).hide(), c.data().flips = 0, a.opts.turn ? (c.css(l(-a.opts.turn.offset().top, -a.opts.turn.offset().left, "auto", "visible").css).appendTo(a.opts.turn), a.opts.turn.data().fparent = c) : c.css(l(0, 0, "auto", "visible").css).attr("id", "turn-fwrappers").appendTo(h("body")), a.fparent = c);this.css({
						position : "absolute",
						top : 0,
						left : 0,
						bottom : "auto",
					...
					}).appendTo(h("<div/>", l(0, 0, 0, "visible")).appendTo(a.fwrapper));a.opts.frontGradient && (a.ashadow = h("<div/>", l(0, 0, 1)).appendTo(a.fpage));i.setData.call(this, a);i.resize.call(this, !0)
				}
			},
			_fold : function(a) {
				var b = this,
				...
				var o = this.data().f,
					...
					F = function() {
						...
						if (d > E && (k.x += Math.abs(k.y * Math.tan(B)), k.y = 0, Math.round(k.x * Math.tan(G - d)) < u)) return a.y = Math.sqrt(Math.pow(u, 2) + 2 * z.x * m.x), D && (a.y = u - a.y), F();
					...
					x = function(a, c, e, k) {
						var l = [ "0", "auto" ],
							...
							l = 90 != k && -90 != k ? A ? -1 : 1 : 0,
							e = e[0] + "% " + e[1] + "%";
						b.css(c).transform(t(k) + s(a.x + l, a.y, w), e);o.fpage.parent().css(c);o.wrapper.transform(s(-a.x +
				...
				switch (a.corner) {
				case "tl":
					a.x = Math.max(a.x, 1);F();
					x(k, [ 1, 0, 0, 1 ], [ 100, 0 ], c);o.fpage.transform(s(-u, -r, w) + t(90 - 2 * c), "100% 100%");l.transform(t(90) + s(0, -u, w), "0% 0%");
					break;case "tr":
					a.x = Math.min(a.x, r - 1);F();x(j(-k.x, k.y), [ 0, 0, 0, 1 ], [ 0, 0 ], -c);o.fpage.transform(s(0, -r, w) + t(-90 + 2 * c), "0% 100%");l.transform(t(270) + s(-r, 0, w), "0% 0%");
					break;case "bl":
					a.x = Math.max(a.x, 1);F();x(j(k.x, -k.y), [ 1, 1, 0, 0 ], [ 100, 100 ], -c);o.fpage.transform(s(-u, 0, w) + t(-90 + 2 * c), "100% 0%");l.transform(t(270) + s(-r, 0, w), "0% 0%");
					break;case "br":
				...
				if (c) {
					if (b) {
						...
						this.animatef({
							...
							frame : function(b) {
								a.x = Math.round(b[0]);
								a.y = Math.round(b[1]);i._fold.call(g, a)
							}
						})
			...
			hide : function() {
				...
				0 === --a.fparent.data().flips && a.fparent.hide();this.css({
					...
					right : "auto",
					bottom : "auto"
				}).transform("", "0% 100%");a.wrapper.transform("", "0% 100%");a.fwrapper.hide();a.bshadow && a.bshadow.hide();b.transform("", "0% 0%");return this
			},
			hideFoldedPage : function(a) {
				...
				if (b.point) {
					var c = this,
						d = b.point,
						e = function() {
							b.point = null;c.flip("hide");c.trigger("end", [ !1 ])
						};
					if (a) {
			...
			turnPage : function(a) {
				...
				this.trigger("flip").animatef({
					...
					frame : function(c) {
						c = L(d, d, e, e, c);
						a.x = c.x;
						a.y = c.y;i._showFoldedPage.call(b, a)
					},
					complete : function() {
						b.trigger("end", [ !0 ])
					},
			...
			_eventEnd : function() {
				...
				if (!a.disabled && a.point) {
					...
					this.trigger(b, [ a.point ]);b.isDefaultPrevented() || i.hideFoldedPage.call(this, !0)
				}
				a.corner = null
			},
			disable : function(a) {
	...
	h.extend(h.fn, {
		...
		animatef : function(a) {
			...
			if (a) {
				a.to.length || (a.to = [ a.to ]);a.from.length || (a.from = [ a.from ]);a.easing || (a.easing = function(a, b, c, d, e) {
				...
				var c,
					...
					g = function() {
						...
						if (i == a.duration) {
							...
							delete b.effect;
							f.data(b);a.complete && a.complete()
						}
					};
				for (c = 0; c < e; c++) d.push(a.to[c] - a.from[c]);
				b.effect = a;
				b.effect.handle = setInterval(g, h);this.data(b);g()
			} else
				delete b.effect
		}
	});
